...
from utils.vars import classes
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_folder", type=str, help="Path to the folder where the split dataset will be organized", default=r'datasets\yolo_original', nargs='?')
